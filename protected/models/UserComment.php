 ...
 * @property integer $user_commnet_id
...
class UserComment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_commnet_id, user_id, comment_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('user_commnet_id',$this->user_commnet_id);
